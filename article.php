<div class="container my-5">
    <!-- Header Section -->
    <h1 class="text-primary">Manajemen Artikel</h1>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title" id="modalTambahLabel"><i class="bi bi-plus-circle"></i> Tambah Artikel Baru</h5>
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="isi" rows="5" placeholder="Masukkan Isi Artikel" required></textarea>
                            </div>
                            <div class="mb-3">
